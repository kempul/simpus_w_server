object dataKunjungan: TdataKunjungan
  ...
  object fdQueryPasienCari: TFDQuery
    ...
    SQL.Strings = (
        ...
        '(nik) like :paramku or upper(mr) like :paramku or kartu_bpjs lik' +
        'e :paramku')
    Left = 16
    Top = 84
    ParamData = <
  ...
  object fdQ1del: TFDQuery
    Connection = FDConnection1
    SQL.Strings = (
      
        'select no_kartu, tanggal, bpjs_urut, bpjs_kunjungan, poli from j' +
        'kn.pendaftaran_view where idxstr = :idxstr')
    Left = 360
    Top = 360
    ParamData = <
      item
