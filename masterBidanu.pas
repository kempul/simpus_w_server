...
type
  TForm1_masterBidan = class(TForm)
    panelUtama: TJvPanel;
    JvPanel1: TJvPanel;
...
var
  Form1_masterBidan: TForm1_masterBidan;
...
procedure TForm1_masterBidan.awal;
begin
...
procedure TForm1_masterBidan.btn_closeClick(Sender: TObject);
begin
...
procedure TForm1_masterBidan.buka_data;
begin
with dataMaster do
begin
...
procedure TForm1_masterBidan.FormShow(Sender: TObject);
begin
awal;
end;

procedure TForm1_masterBidan.nav1Click(Sender: TObject; Button: TNavigateBtn);
  var apv : string;
begin
...
begin
  apv := dataMaster.uqMasterBidan.FieldByName('idx').AsString;
  grid1.Options := grid1.Options - [dgEditing] + [dgRowSelect];
