...
constructor srvMImunisasi.Create;
begin
  inherited Create;
  aScript := TStringList.Create;
end;

destructor srvMImunisasi.destroy;
begin
aScript.Free;
inherited;
end;

function srvMImunisasi.getMImunisasi: Boolean;
...
function srvMImunisasi.jsonToSql(table, json: string; update: Boolean;
  pkey: string): string;
...
procedure srvMImunisasi.masukkangetImunisasi;
