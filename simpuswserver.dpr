...
uses
  ...
  master_poli_antrianu in 'master_data\master_poli_antrianu.pas' {Form1_masterPoliAntrian},
  ...
  srvCommonsU in 'simpusserver\srvCommonsU.pas',
  srvAntriU in 'simpusserver\srvAntriU.pas',
  srvDaftarU in 'simpusserver\srvDaftarU.pas',
  srvPasienU in 'simpusserver\srvPasienU.pas',
  kirim_dinkes_u in 'kirim_dinkes_u.pas' {Form1_kirim_dinkes},
  dm_kirim_dinkes in 'dm_kirim_dinkes.pas' {dataKirimDinkes: TDataModule},
  srvKunjunganU in 'simpusserver\srvKunjunganU.pas',
  srvFisikU in 'simpusserver\srvFisikU.pas',
  srvIcdxU in 'simpusserver\srvIcdxU.pas',
  srvDiagnosaU in 'simpusserver\srvDiagnosaU.pas',
  srvImunisasiU in 'simpusserver\srvImunisasiU.pas',
  srvPonedU in 'simpusserver\srvPonedU.pas',
  srvTindakanU in 'simpusserver\srvTindakanU.pas',
  srvTindakangigiU in 'simpusserver\srvTindakangigiU.pas',
  srvPulangU in 'simpusserver\srvPulangU.pas',
  srvMeninggalU in 'simpusserver\srvMeninggalU.pas',
  srvMImunisasiU in 'simpusserver\srvMImunisasiU.pas',
  srvPuskesmasU in 'simpusserver\srvPuskesmasU.pas',
  srvPoliU in 'simpusserver\srvPoliU.pas',
  srvRawatinapU in 'simpusserver\srvRawatinapU.pas',
  srvKamarU in 'simpusserver\srvKamarU.pas',
  srvMkelasU in 'simpusserver\srvMkelasU.pas',
  bantuUrlU in 'bantuUrlU.pas',
...
begin
  ...
  Application.CreateForm(TdataKirimDinkes, dataKirimDinkes);
  ...
  Application.CreateForm(TForm1_kirim_dinkes, Form1_kirim_dinkes);
  Application.Run;
end.
