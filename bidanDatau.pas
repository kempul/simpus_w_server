...
var
  Form1_bidanData: TForm1_bidanData;
...
procedure TForm1_bidanData.awal;
begin
grid1.RestoreColumnsLayoutIni(Form111.MyIni, name, [crpColWidthsEh]);
buka_data;
end;

procedure TForm1_bidanData.btn_closeClick(Sender: TObject);
begin
...
procedure TForm1_bidanData.buka_data;
begin
with dataMaster do
begin
...
procedure TForm1_bidanData.FormShow(Sender: TObject);
begin
awal;
end;

procedure TForm1_bidanData.nav1Click(Sender: TObject; Button: TNavigateBtn);
  var apv : string;
begin
