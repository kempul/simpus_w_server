...
type
  ...
  private
    ...
    procedure kirim_kamar_inap(id : string);
...
uses aau, aau111, dmRI, pulangBantuU, ICDXCariu, gigiBantuU,
  ...
  faskesRujukanU, lab_bpjs, srvKamarU; //SrvParallelU, srvFisikU,
...
kamar := dbedit1Kamar.Field.AsString;
...
begin
  ...
  simpan_rawat_inap(Form1_bedDlg.labelKamar.Caption);
    ...
    buka_data;
      ...
      kirim_kamar_inap(Form1_bedDlg.labelKamar.Caption);
    end;
...
begin
Form1_labBpjs.lblPasien.Caption := dbtxtnama_lengkap.Field.AsString;
...
procedure TForm1_pelayananRI.kirim_kamar_inap(id: string);
var srv : srvKamar;
begin
...
begin
  ...
  try
    srv.bpjsAllPostNonParallel(idxstr);
  finally
    srv.Free;
  end;
end;
