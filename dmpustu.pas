...
type
  TdataPustu = class(TDataModule)
    ...
    q_pustuCetak: TUniQuery;
    uspPustuData: TUniStoredProc;
    qPustu: TUniQuery;
    dsPustu: TJvDataSource;
    qPustuData: TUniQuery;
    dsPustuData: TJvDataSource;
    q_pustuKesakitan: TUniQuery;
    ds_pustuKesakitan: TJvDataSource;
    q_pustuKesakitanPV: TUniQuery;
    ds_pustuKesakitanPV: TJvDataSource;
    q_pustuKesakitanPv0: TUniQuery;
    ds_pustuKesakitanPv0: TJvDataSource;
    usp_pustuKesakitanInsert: TUniStoredProc;
    uq_kesakitanCetak: TUniQuery;
    qproses: TUniSQL;
    uniQICDXCari: TUniQuery;
    dsICDXCari: TJvDataSource;
...
procedure TdataPustu.DataModuleCreate(Sender: TObject);
begin
getpg;
end;

procedure TdataPustu.getpg;
begin
