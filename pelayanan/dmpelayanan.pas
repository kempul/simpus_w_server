...
uses kunciu, aau111, aau, brPendaftaranU, OtlParallel, brTindakanU, brObatU;
//, srvFisikU, SrvParallelU;
...
var id : string;
begin
//ShowMessage('tindakan before');
id := DataSet.FieldByName('id').OldValue;
//ShowMessage('obat before : ' + id);
hapusPasienObat(id);
end;
...
//ShowMessage('tindakan before : ' + id);
hapusTindakan(id);
end;
