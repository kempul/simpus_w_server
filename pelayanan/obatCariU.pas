...
implementation
        uses dmpelayanan, obatCaridiPcareU, aau111, brObatU;
{$R *.dfm}
...
try
   ...
   if brO.getObatRef(Form1_obatCariDiPCARE.labelEdit1.Text, '0', '1000') then
   ShowMessage('BPJS OK') else ShowMessage('BPJS Gagal');
   finally
     brO.Free;
   end;
   pb1.Hide;
