...
type
  TForm1_masterPoliAntrian = class(TForm)
    panelUtama: TJvPanel;
    JvPanel1: TJvPanel;
...
var
  Form1_masterPoliAntrian: TForm1_masterPoliAntrian;
...
procedure TForm1_masterPoliAntrian.awal;
begin
grid1.RestoreColumnsLayoutIni(Form111.MyIni, Name, [crpColWidthsEh]);
buka_data;
end;

procedure TForm1_masterPoliAntrian.btn_closeClick(Sender: TObject);
begin
...
procedure TForm1_masterPoliAntrian.btn_mutasiClick(Sender: TObject);
var jkn : brProvider;
begin
...
procedure TForm1_masterPoliAntrian.btn_pakandikandangClick(Sender: TObject);
...
procedure TForm1_masterPoliAntrian.buka_data;
begin
with dataMaster do
begin
...
procedure TForm1_masterPoliAntrian.FormShow(Sender: TObject);
begin
awal;
end;

procedure TForm1_masterPoliAntrian.isi_list(aQuery, aField: string;
...
procedure TForm1_masterPoliAntrian.nav1Click(Sender: TObject; Button: TNavigateBtn);
  var apv : string;
begin
...
begin
  apv := dataMaster.fdQMasterPoliAntrian.FieldByName('poli_antrian').AsString;
  grid1.Options := grid1.Options - [dgEditing] + [dgRowSelect];
  buka_data;
  dataMaster.fdQMasterPoliAntrian.Locate('poli_antrian', apv, []);
end;
